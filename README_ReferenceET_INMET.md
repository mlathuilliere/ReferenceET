...
## Data should have first been analyzed and manipulated into Aquarius or other program, with an exported .csv 
## file containing the following headings (stdev = standard deviation):
